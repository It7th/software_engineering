...
private:
    pqxx::connection openConnection() const;
    void ensureLoginAvailable(pqxx::transaction_base& txn, const std::string& login);
    void ensureEmailAvailable(pqxx::transaction_base& txn, const std::string& email);
    bool userExists(pqxx::transaction_base& txn, int userId);
    bool courseExists(pqxx::transaction_base& txn, int courseId);
    UserRow getUserById(pqxx::transaction_base& txn, int userId);
    CourseRow getCourseById(pqxx::transaction_base& txn, int courseId);
    LessonRow getLessonById(pqxx::transaction_base& txn, int lessonId);
    EnrollmentRow getEnrollmentById(pqxx::transaction_base& txn, int enrollmentId);
...
private:
    ...
    static std::string resolveDatabaseConnectionString();
